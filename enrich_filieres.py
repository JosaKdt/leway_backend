...
DATA = {
    ...
    "Planification et Développement Local": {
        "description": "Filière axée sur la planification territoriale, le développement communal et la gestion de projets de développement au Bénin.",
    ...
    "Diplomatie et Relations Internationales": {
        "description": "Formation aux relations entre États, au droit international et à la diplomatie. Prépare aux métiers des affaires étrangères et des organisations internationales actives au Bénin.",
    ...
    "Pêche et Aquaculture": {
        "description": "Formation à la gestion des ressources halieutiques, à l'aquaculture et à la pêche durable dans le contexte côtier et lagunaire du Bénin.",
    ...
    "Marketing et Action Commerciale": {
        "description": "Formation aux techniques de vente, de marketing et de gestion commerciale. Prépare à concevoir et mettre en oeuvre des stratégies commerciales adaptées au marché béninois et ouest-africain.",
    ...
    "Économie Publique et Statistique": {
        "description": "Formation avancée à l'économie publique, aux politiques fiscales et aux méthodes quantitatives. Niveau master orienté recherche et institutions internationales.",
    ...
    "Architecture et Urbanisme": {
        ...
        "debouches": ["Architecte", "Urbaniste", "Designer d'intérieur", "Chef de projet urbain", "Maître d'oeuvre"],
        "niveau_admission": "Bac", "cout_annuel_min": 80000, "cout_annuel_max": 500000,
        "langue_enseignement": "Français", "accreditation_mesrs": True, "accreditation_cames": True, "taux_reussite": 0.72,
    },
...
def enrich():
    with Session(engine) as session:
        ...
        print(f"\n{'='*55}")
        print(f"  {len(to_enrich)} filieres a enrichir sur {len(filieres)} total")
        print(f"{'='*55}\n")
        ...
        for filiere in to_enrich:
            ...
            session.add(filiere)
            success += 1
            print(f"  OK {filiere.nom}")

        session.commit()

        print(f"\n{'='*55}")
        print(f"  {success} filieres enrichies")
        if not_found:
            print(f"\n  ATTENTION: {len(not_found)} filieres non trouvees dans le dictionnaire :")
            for n in not_found:
                print(f"    - {n}")
        print(f"{'='*55}\n")
